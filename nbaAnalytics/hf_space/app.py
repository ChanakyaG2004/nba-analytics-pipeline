...
[data-testid="stSidebar"]{background:var(--navy);border:0}[data-testid="stSidebar"]>div{padding:1.25rem 1rem}[data-testid="stSidebar"] *{color:#dce3ef}[data-testid="stSidebar"] [data-testid="stRadio"] label{padding:.62rem .7rem;border-radius:10px;margin-bottom:.12rem}[data-testid="stSidebar"] [data-testid="stRadio"] label,[data-testid="stSidebar"] [data-testid="stRadio"] label p,[data-testid="stSidebar"] [data-testid="stRadio"] label span,[data-testid="stSidebar"] [data-testid="stRadio"] label div{color:#dce3ef!important;-webkit-text-fill-color:#dce3ef!important}[data-testid="stSidebar"] [data-testid="stRadio"] label:hover{background:#ffffff12}[data-testid="stSidebar"] [data-testid="stRadio"] label:has(input:checked){background:#f15a2930}[data-testid="stSidebar"] [data-testid="stRadio"] label:has(input:checked),[data-testid="stSidebar"] [data-testid="stRadio"] label:has(input:checked) p,[data-testid="stSidebar"] [data-testid="stRadio"] label:has(input:checked) span,[data-testid="stSidebar"] [data-testid="stRadio"] label:has(input:checked) div{color:#fff!important;-webkit-text-fill-color:#fff!important;font-weight:700}[data-testid="stSidebar"] [data-testid="stRadio"]>label{display:none}[data-testid="stSidebar"] hr{border-color:#ffffff18}
